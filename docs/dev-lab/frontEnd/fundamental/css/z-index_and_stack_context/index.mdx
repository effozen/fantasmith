...
import stacking_context_example from './img/stacking_context_example.png'
...
<details>
  ...
  * {
  ...
  <figure>
    <img src={stacking_context_example} alt='z-index 이미지'/>
    <figcaption>[이미지 출처 : MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_positioned_layout/Understanding_z-index/Stacking_context) </figcaption>
  </figure>
...
import z_index_axes from './img/z_index_axes.png'

<figure>
  <img src={z_index_axes} alt='z-index 이미지'/>
  <figcaption>[이미지 출처 : codrops](https://tympanus.net/codrops/css_reference/z-index/) </figcaption>
</figure>
...
import default_stacking_order from './img/default_stacking_order.png'

<figure>
  <img src={default_stacking_order} alt='z-index 이미지'/>
  <figcaption>[이미지 출처 : codrops](https://tympanus.net/codrops/css_reference/z-index/) </figcaption>
</figure>
...
import new_stacking_order from './img/new_stacking_order.png'

<figure>
  <img src={new_stacking_order} alt='z-index 이미지'/>
  <figcaption>[이미지 출처 : codrops](https://tympanus.net/codrops/css_reference/z-index/) </figcaption>
</figure>
