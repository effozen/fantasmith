...
image: '/media/reactLab/optimization/first_optimizing/img/index.webp'
...
keywords: ['react', 'reactLab', 'performance', 'optimization']
sidebar_position: 3
sidebar_label: '해보면서 느낀 리액트 성능 최적화에 대한 고찰'
sidebar_custom_props:
  img: '/media/reactLab/optimization/first_optimizing/img/index.webp'
last_update:
  date: 2025-01-03
  author: zen
---
...
2024년 회고를 진행하면서 스스로를 돌아보니, <strong>'구현'</strong>에 급급했지, 그 이상의 것을 고려하고 있었다.
...
<TabItem value="결과" label="결과">
  <Figure fileName="function_equality.webp" alt="함수 동등성 예시" caption="함수 동등성 예시" />
</TabItem>
...
const contextValue: AppContextType = useMemo(
  ...
  [theme, toggleTheme, user, login, logout, notifications, addNotification, removeNotification]
);
```
...
[리액트 개발자 도구 탐구](http://localhost:3000/reactLab/optimization/dev_tool/)에서 배운 리액트 개발자 도구를 활용한다.
...
<Figure fileName="before_flame.webp" alt="기존 성능 측정" caption="기존 성능 측정" />

</TabItem>

<TabItem value="최적화 후 성능 측정" label="최적화 후 성능 측정">

<Figure fileName="after_flame.webp" alt="최적화 후 성능 측정" caption="최적화 후 성능 측정" />
...
<Figure fileName="before_flame_bad.webp" alt="기존 성능 측정" caption="기존 성능 측정" />

</TabItem>

<TabItem value="최적화 후 성능 측정" label="최적화 후 성능 측정">

<Figure fileName="after_flame_bad.webp" alt="최적화 후 성능 측정" caption="최적화 후 성능 측정" />
