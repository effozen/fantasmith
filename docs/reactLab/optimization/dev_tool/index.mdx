---
title: '리액트 개발자 도구 탐구'
image: '/media/reactLab/optimization/dev_tool/img/index.webp'
...
keywords: ['react', 'reactLab', 'dev-tool', 'performance', 'optimization']
sidebar_position: 2
sidebar_label: '리액트 개발자 도구 탐구'
sidebar_custom_props:
  img: '/media/reactLab/optimization/dev_tool/img/index.webp'
last_update:
  date: 2025-01-02
  author: zen
---
...
<Figure fileName="chrome_dev_tool.webp" alt="크롬 개발자 도구" caption="크롬 개발자 도구" />
...
<Tabs>
  <TabItem value="Components 패널" label="Components 패널" default>
    <Figure fileName="components.webp" alt="Components 패널" caption="Components 패널" />
  </TabItem>
  <TabItem value="Profiler 패널" label="Profiler 패널">
    <Figure fileName="profiler.webp" alt="Profiler 패널" caption="Profiler 패널" />
  </TabItem>
</Tabs>
...
<Figure fileName="component1.gif" alt="Components 탭 사용 예" caption="Components 탭 사용 예" />
...
<Figure fileName="dev_tool_loggin2.webp" alt="Loggin 버튼" caption="Loggin 버튼" />

가운데 벌레(bug) 모양을 클릭하면 콘솔에 `props`, `hooks`, `DOM에 있는 노드`, `시스템에서의 파일 위치` 등 컴포넌트와 관련된 모든 내용을 콘솔에 출력할 수 있다.

### Component Filtering

<Figure fileName="dev_tool_filtering.gif" alt="Filtering 예" caption="Filtering 예" />
...
<Figure fileName="profiling1.gif" alt="Profile 사용 예" caption="Profile 사용 예" />
...
<Figure fileName="commit_chart2.webp" alt="커밋 차트 상세" caption="커밋 차트 상세" />
...
<Figure fileName="profile_filter.gif" alt="Profile 필터링" caption="Profile 필터링" />
...
<Figure fileName="flame_chart2.webp" alt="플레임 차트 상세" caption="플레임 차트 상세" />
...
<Figure fileName="json.webp" alt="출력되는 JSON 값" caption="출력되는 JSON 값" />
