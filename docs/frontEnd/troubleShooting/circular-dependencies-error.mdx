...
[스토리북의 스토리를 작성하다 마주한 순환 참조 문제](/frontEnd/tools/storybook/circular-dependency-error)
...
[스토리북 작성 중 발생한 순환 참조 에러 해결하기: Dropdown 컴포넌트 사례 분석](/frontEnd/tools/storybook/circular-dependency-error)
