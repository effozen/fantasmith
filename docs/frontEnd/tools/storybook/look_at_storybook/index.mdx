...
<Figure fileName='storybook-directory-list.webp' alt='스토리북 템플릿의 디렉토리 구조' caption='스토리북 템플릿의 디렉토리 구조' />
...
[합성 패턴(Composition pattern)으로 살펴보는 리액트 컴포넌트 설계 핵심](/react-lab/principles/base/composition-pattern/)
...
<Figure fileName='storybook-buuton-screen-img.webp' alt='스토리북 이미지' caption='스토리북 이미지' />
...
<Figure fileName='storybook-button-title.webp' alt='스토리북 사이드바 화면' caption='스토리북 사이드바 화면' />
...
<Figure fileName='storybook_button_parameters_center.webp' alt='스토리북 컴포넌트 화면' caption='스토리북 컴포넌트 화면' />
...
<Figure fileName='storybook_button_parameters_left.webp' alt='스토리북 컴포넌트 화면' caption='스토리북 컴포넌트 화면' />
...
<Figure fileName='storybook_button_tags_error.webp' alt='스토리북 메인 화면에서 에러 발생' caption='스토리북 메인 화면에서 에러 발생' />
...
<Figure fileName='storybook_button_argTypes.webp' alt='스토리북 컴포넌트의 props 조절 화면' caption='스토리북 컴포넌트의 props 조절 화면' />
...
<Figure fileName='storybook_button_stories.webp' alt='스토리북 컴포넌트의 props 조절 화면' caption='스토리북 컴포넌트의 props 조절 화면' />
