...
image: '/media/frontEnd/tools/storybook/circular_dependency_error/img/index.webp'
...
sidebar_position: 3
sidebar_label: '스토리 작성 중 순환 참조 에러 해결기'
sidebar_custom_props:
  img: '/media/frontEnd/tools/storybook/circular_dependency_error/img/index.webp'
last_update:
  date: 2024-11-17
  author: zen
---
...
<Figure fileName='storybook_error_circular_dependency_error.webp' alt='스토리북 사용 중 만난 에러' caption='스토리북 사용 중 만난 에러' />
...
[자바스크립트에서의 순환 참조 문제](/frontEnd/troubleShooting/circular-dependencies-error)
...
<Figure fileName='storybook_error_circular_dependency_solved.webp' alt='에러가 해결된 모습' caption='에러가 해결된 모습' />

## 📝 번외 : 스토리북에서 Context 제공하기

`DropdownTrigger`를 스토리북에서 사용하려면 `ToggleProvider`를 데코레이터로 추가하여 컨텍스트를 제공해야 한다.<br/>

이에 대해서는 다음 글에 정리해두었으니 참고하자.<br/>
