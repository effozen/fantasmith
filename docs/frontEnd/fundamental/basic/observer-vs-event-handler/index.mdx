...
<Figure
  ...
  alt="question"
  caption="옵저버와 이벤트 핸들러의 차이가 뭘까?"
  href="https://pixabay.com/ko/illustrations/%ED%98%BC%EB%9E%80%EC%8A%A4%EB%9F%AC%EC%9A%B4-%EB%AC%BC%EC%9D%8C%ED%91%9C-%EC%86%8C%EB%85%84-%EC%A7%88%EB%AC%B8-6223819/"
/>
...
<Figure fileName="starcraft_observer.webp" alt="스타크래프트 옵저버" caption="스타크래프트 옵저버" />
