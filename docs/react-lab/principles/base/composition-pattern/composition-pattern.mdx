...
이번에 [복합 컴포넌트 패턴으로 컴포넌트 재사용 높이기](/react-lab/dev-log/component_making/component_composition_pattern_with_header/component_composition_pattern_with_header)와 [Dropdown 컴포넌트를 구현하고 이룬 성장](/react-lab/dev-log/component_making/dropdown_and_growth/dropdown_and_growth)에 적힌 컴포넌트들을 구현하면서 이 개념의 의미가 💡! 하고 받아들여지게 되었다.<br/>
...
[복합 컴포넌트 패턴으로 컴포넌트 재사용 높이기](/react-lab/dev-log/component_making/component_composition_pattern_with_header/component_composition_pattern_with_header) <br/>
